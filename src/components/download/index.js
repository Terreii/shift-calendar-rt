...
import { shiftModelText, shift66Name, shift64Name } from '../../lib/constants'
...
export default ({ shiftModel }) => {
  if (!(shiftModel in urls)) {
    return <div class={style.main}>Für dieses Schichtmodell sind die Kalender noch in Arbeit</div>
  }
